...
export const ActionTV = ({ navigation, route }) => {
  ...
  const trailerKeys =
    trailer.length > 0 ? trailer.map((trailerkey) => trailerkey.key) : [];
  ...
  return (
    ...
    <View style={{ flex: 1 }}>
      ...
      <SafeAreaView
        style={{ backgroundColor: "#26282C", flex: 1, paddingTop: 40 }}
      >
        <View
          style={{
            display: "flex",
        ...
        >
          ...
          >
            ...
            <View
              style={{ width: "100%", backgroundColor: "#26282C", height: 190 }}
            >
              <YoutubeIframe
                height={"100%"}
                width={"100%"}
